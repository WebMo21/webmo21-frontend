...
const DeleteWorkoutModal = ({
  ...
  return (
    <Transition.Root
      show={showSetUserInactiveModal ? showSetUserInactiveModal : false}
      as={Fragment}
    >
      <Dialog
        as="div"
        ...
        open={showSetUserInactiveModal}
        onClose={setShowSetUserInactiveModal}
      >
              ...
              <div>
                ...
                <div className="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                  ...
                  <button
                    ...
                    onClick={() => setShowSetUserInactiveModal(false)}
                    ref={cancelButtonRef}
                  >
