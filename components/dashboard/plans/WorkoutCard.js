    ...
    <div
      ...
      className={`${
        selectedWorkout === id
          ...
          : "scale-100"
      } flex transition duration-300 ease-in transform bg-gray-700 rounded-lg hover:scale-105 iphone:flex-col iphone:items-center tabletpro:m-4 tabletpro:mx-44 tablet:!mx-4 mb-4 cursor-pointer iphonebg`}
